...
- [ ] **发布阻断（fantgpu 5.0.0-iN 线）**：② `validation-results.json` 未签；③ tag
  ...
  在 R28 接受精确 i9 的真实八核安装证据后裁定解除；R31 独立终审已将解除范围覆盖至 i10，
...
由 `78963e1` 收档，R31 八核受监督安装已由 `3419079` 收档。用户另行授权重启后，
i10/107 基础首启与18/18输入挂接观察通过，证据待复核；输入失败分支未动态验证。F/Deepin 运行能力对齐
...
[D4 记录](../history/history.md#2026-09-21-r20-d4-归档闭合)。R21 的 R02–R16 共 15 篇
[公开阅读版](../history/history.md#轮次公开阅读版索引)已由 `e520258` 收档，qoder 初审与 dsh 终审通过。
运行冻结不随文档进度解除。
