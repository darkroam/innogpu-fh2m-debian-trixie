...
- [ ] **文档工具适配（R19）**：R18 主体已闭合，见 [实施历史](../history/history.md#2026-09-21-r18-主体闭合与工具适配接续)。
  六篇文档迁移与检查脚本适配正在本批收档；qoder 初审、dsh 终审及提交尚待完成。
  D2（R01 叙事提升 tracked 试点）与 D4（归档五条件筛查）继续单独排队；
  运行冻结不随文档进度解除。
