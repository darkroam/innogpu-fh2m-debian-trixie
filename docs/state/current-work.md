...
- [ ] **叙事提升与归档（R20）**：R19 工具适配已由 `e656612` 收档闭合，见
  [实施历史](../history/history.md#2026-09-21-r19-工具适配闭合)。先做
  [R01 阅读版试点](../history/rounds/r01-2026-08-31-docs-sorting.md)，待 qoder 初审与 dsh 终审。
  D4（归档五条件筛查）须在 D2 单独闭合后推进；其余轮次提升待另行放行。
  运行冻结不随文档进度解除。
