...
| **P5 台账** | 19 项台账 + 59 语义裁决记录 + 435 per-file 证据 | `docs/investigations/fantgpu-base-update-evaluation.md` |
...
- **O-2**：D → D_stage 完整性审计
  - 见 `docs/design/030-d-stage-audit.md`（v5 新增，验证阶段一确实收齐了
...
1. 方案文档：
   ...
   - docs/design/030-d-stage-audit.md（O-2 v24 闭合版）
