...
| 源码树迁移 | 阶段 0–4 完成（新构建器 4.0.0-i1 并行验证 + 实机候选验证与回退演练全 PASS）；设备已运行 4.0.0-i1；阶段 5 旧流程退役待执行 | [source-tree-migration](../planning/source-tree-migration.md)、[phase4 验证](../planning/phase4-device-validation.md) |
