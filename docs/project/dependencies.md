...
| `build/innogpu-fh2m-trixie_4.0.2-i2.deb`（R12 候选） | i1 + patch-028 温度 work 恢复时序门禁；固定 epoch 1788710400；不含 display 025；仅静态/离线验证，尚未安装 |
...
`4.0.2-i2` 在 patch-024 后应用 patch-026 生命周期同步与 patch-028 温度 work 恢复时序门禁，
