...
| `build/innogpu-fh2m-trixie_4.0.1-i2.deb`（R05 当前运行包） | patch-024 + patch-025-suspend-resume-display；固定 epoch 1788364800，历史 SHA `b26c0b27…`；一次 s2idle 可见恢复通过，不作为 R06 严格 A/B 包复用 |
| `build/innogpu-fh2m-trixie_4.0.1-i3.deb`（R06 A） | 仅 patch-024；固定 epoch 1788451200；SHA `6cab9e521046b386ec2e34ce84d384302b044a4c215c836566274d5de769dcba`；严格对照准备通过，尚未安装 |
