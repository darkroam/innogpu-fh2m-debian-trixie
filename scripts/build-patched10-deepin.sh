...
install -m 0755 scripts/xdisplay.sh "$W/root/usr/share/innogpu-fh2m-trixie/xdisplay.sh"
install -m 0755 scripts/displayselect "$W/root/usr/share/innogpu-fh2m-trixie/displayselect"
install -m 0755 scripts/xdisplay-session.sh "$W/root/usr/share/innogpu-fh2m-trixie/xdisplay-session.sh"
install -m 0755 scripts/install-xdisplay-user.sh "$W/root/usr/share/innogpu-fh2m-trixie/install-xdisplay-user.sh"
