...
for p in \
    ...
    "patches/023-invisible-read-no-writeback.patch" \
    "patches/024-suspend-resume.patch" \
    "patches/025-dma-resv-usage-rw.patch" \
...
echo "recipe=Deepin_20250421190503 + patched-27(001,002,006,009,007,023,024,025,026,027) + 026-lifecycle + 028 + 029 + patch-000"
