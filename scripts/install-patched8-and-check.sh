...
[[ -f "$deb" ]] || { echo "Missing package: patched-8 deb. Put it in $ROOT/debs/ or set INNOGPU_PATCHED8_DEB." >&2; exit 1; }
[[ -f "$fallback_deb" ]] || { echo "Missing fallback package: patched-17 deb. Put it in $ROOT/debs/ or set INNOGPU_PATCHED17_DEB." >&2; exit 1; }
