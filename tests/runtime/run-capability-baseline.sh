...
if [[ "$MODE" == "allow-authorized" ]]; then
    ...
    printf '#   vulkan_execution: tools/probe-vulkan-devices.c 编译并创建 instance/device + 最小渲染\n'
    printf '#   opencl_execution: tools/probe-opencl-devices.c 编译并执行最小 kernel/buffer 读写\n'
